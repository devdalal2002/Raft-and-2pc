...
class RaftConsensusStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RequestVote = channel.unary_unary(
                '/raft.RaftConsensus/RequestVote',
        ...
        self.AppendEntries = channel.unary_unary(
                '/raft.RaftConsensus/AppendEntries',
...
class RaftConsensusServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_RaftConsensusServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'raft.RaftConsensus', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('raft.RaftConsensus', rpc_method_handlers)
